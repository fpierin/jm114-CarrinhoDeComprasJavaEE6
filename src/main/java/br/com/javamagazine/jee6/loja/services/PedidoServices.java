...
public class PedidoServices {
	...
	public Pedido criarPedido(final Pedido pedido, final String emailCliente, final String senhaCliente) throws ClienteNaoEncontradoException {
		final Cliente cliente = clienteServices.findByEmailAndSenha(emailCliente, senhaCliente);
		if (cliente == null) {
